      ...
      <div className="animate-fade-in">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <SkillCategory 
            ...
            icon={<WrenchScrewdriverIcon className="h-10 w-10 text-dark-accent" />}
          />
          
          <SkillCategory 
            title="Other Skills" 
            skills={["UI/UX Design", "Responsive Design", "Testing", "SEO", "Performance Optimization"]}
            icon={<CommandLineIcon className="h-10 w-10 text-dark-accent" />}
          />
        </div>
      </div>
    </section>
