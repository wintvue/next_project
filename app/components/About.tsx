export default function About() {
  return (
    <section id="about" className="py-12 md:py-20 w-full bg-dark-primary bg-center bg-no-repeat bg-fixed bg-[url('/about_desk.png')]">
        ...
        <div className="grid md:grid-cols-1 gap-8 max-w-4xl mx-auto">
          <div className="mt-6 md:mt-12">
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
              ...
              I'm eager to offer practical solutions to problems that require cutting edge technology such as AI. My interest in AI fuels my enthusiasm for integrating it into applications.
            </p>
          </div>
        </div>
